Extracted 14 translation units from markdown_readme
==================================================

--- Unit 1 ---
ID: readme.md_comment_0
Type: comment
...
Type: format_string
Position: Line 16, Column 6 (Offset: 243)
Content:
s how to use the project:

```rust
fn main() {
    // This is code inside markdown
    println!(

--- Unit 5 ---
ID: readme.md_comment_3
Type: comment
Position: Line 20, Column 8 (Offset: 297)
Content:
This is code inside markdown
...
Type: comment
Position: Line 75, Column 4 (Offset: 1235)
Content:
This looks like a comment but is text

--- Unit 14 ---
ID: readme.md_comment_12
Type: comment
Position: Line 76, Column 3 (Offset: 1275)
Content:
This is a header, not a shell comment
